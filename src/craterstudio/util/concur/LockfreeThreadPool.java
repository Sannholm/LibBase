...
public class LockfreeThreadPool implements Executor
{
    ...
    public LockfreeThreadPool(int maxWorkers, long workerTimeout)
    {
        ...
        taskQueue = new SimpleBlockingQueue<Runnable>();
        this.maxWorkers = maxWorkers;
        
        shutdownLatch = new AwaitZeroLatch(1);
        
        potentialWorkersLeft = new Semaphore(maxWorkers + 1);
    ...
    {
        return maxWorkers - potentialWorkersLeft.availablePermits();
    }
    ...
    public void putTask(Runnable task)
    {
        ...
        if (isShutdown && task != TERMINATE_WORKER)
        {
    ...
    public void shutdown(boolean flushTaskQueue, boolean waitFor)
    {
        ...
        int count = Math.max(10, countWorkers() * 10);
