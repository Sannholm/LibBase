...
public class ThreadPool
{
    ...
    public ThreadPool(int minIdle, int maxBusy)
    {
        ...
        busyWorkers = new AtomicInteger();
        idleWorkers = new AtomicInteger();
        aliveWorkers = new AtomicInteger();
        
        minIdleWorkers = minIdle;
        maxBusyWorkers = maxBusy;
        
        queue = new ConcurrentQueue<Runnable>(true);
    ...
    class PoolMonitor implements Runnable
    {
        ...
        public void run()
        {
            ...
            while (true)
            {
                ...
                Thread t;
                if (factory == null) t = new Thread(worker);
                else
