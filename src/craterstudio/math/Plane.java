...
import static craterstudio.math.VecMath.dot;
import static craterstudio.math.VecMath.normal;
...
public class Plane
{
    ...
    {
        origin = new Vec3(normal).length(d);
        this.normal = normal;
    }
    ...
    {
        return signedDistanceTo(p) >= 0.0f;
    }
