...
public abstract class MultipartBoundaryMatcher
{
    ...
    {
        boundary = Text.ascii("--" + multipartBoundary + "\r\n");
        lastpart = Text.ascii("--" + multipartBoundary + "--");
    }
    ...
    public void transfer(InputStream in, OutputStream out) throws IOException
    {
        ...
        while (true)
        {
            ...
            if (indexOf1 == 0 || indexOf2 == 0)
            {
                ...
                onBoundary(out, dataBuffer, 0, boundary.length);
                writeOffset = consume(out, dataBuffer, writeOffset, boundary.length, false);
            ...
            else if (indexOf1 == -1 && indexOf2 == -1)
            {
                ...
                writeOffset = consume(out, dataBuffer, writeOffset, dataBuffer.length, true);
            }
            else
            {
                // maybe delimiter
                ...
                writeOffset = consume(out, dataBuffer, writeOffset, before, true);
            }
        }
    }
