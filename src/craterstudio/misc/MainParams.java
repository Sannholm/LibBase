...
{
    private final Set<Character> definedFlags = new HashSet<Character>();
    private final Set<Character> definedKeyVals = new HashSet<Character>();
    private final Set<String> definedProps = new HashSet<String>();
    ...
    private final Map<String, String> setProps = new HashMap<String, String>();
    private final List<String> setArgs = new ArrayList<String>();
    ...
    {
        return Collections.unmodifiableList(setArgs);
    }
    
    public boolean isSet(String name)
    {
        return setProps.containsKey(name);
    }
